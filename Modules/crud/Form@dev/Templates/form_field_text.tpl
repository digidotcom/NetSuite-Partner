...
{{#if showContent}}
    ...
    <div class="form-fields-form-controls" data-validation="control">
        ...
        {{else}}
            <input type="{{inputType}}" class="form-fields-input" id="{{attribute}}" name="{{attribute}}" data-value="{{value}}" value="" placeholder="{{placeholder}}" {{#if isCurrency}}min="0.00" step="0.01"{{/if}} />
            {{#if help}}
